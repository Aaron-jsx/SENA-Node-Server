...
const cors = require('cors'); // Importante: asegúrate de tener 'cors' instalado (npm install cors)
...
// 1. Define aquí los dominios que tienen permiso para conectarse.
const allowedOrigins = [
    'https://lasena.byethost31.com', // El dominio de tu frontend
    'https://sena-videocall.000webhostapp.com', // Otro dominio que tenías en tu lista
    'http://localhost', // Para tus pruebas en local
    'http://127.0.0.1'  // Para tus pruebas en local
];

// 2. Configura las opciones de CORS.
const corsOptions = {
  origin: function (origin, callback) {
    // Permite las solicitudes de tu lista de dominios y las que no tienen origen (como Postman o apps móviles)
...
// 3. Aplica la configuración de CORS a Express.
app.use(cors(corsOptions));

// 4. Pasa la misma configuración de CORS a Socket.IO.
